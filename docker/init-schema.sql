-- Docker Postgres initialization script
-- Generated from supabase/schema.sql (canonical source of truth)
-- Stripped of Supabase-specific features: auth.uid(), auth.role(), RLS, policies
-- For local Docker postgres container initialization only
