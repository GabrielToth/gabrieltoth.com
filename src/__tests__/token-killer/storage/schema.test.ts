...
describe("Database Schema Module", () => {
    ...
    describe("Index Creation", () => {
        ...
        it("should create indexes for token_records table", async () => {
            ...
            const tokenRecordsIndexes = verification.indexes.filter(idx =>
                idx.includes("token_records")
            )
        ...
        it("should create indexes for budget tables", async () => {
            ...
            const budgetIndexes = verification.indexes.filter(idx =>
                idx.includes("budget")
            )
        ...
        it("should create indexes for strategies table", async () => {
            ...
            const strategyIndexes = verification.indexes.filter(idx =>
                idx.includes("strategies")
            )
