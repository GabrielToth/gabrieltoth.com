/**
 * Security Tests for GET /api/oauth/callback/kick — Attack Matrix
 *
...
import { GET } from "@/app/api/oauth/callback/kick/route"
...
const mockExchangeCodeForToken = vi.hoisted(() =>
    vi.fn().mockResolvedValue({
        accessToken: "mock-kick-access-token",
...
describe("GET /api/oauth/callback/kick — Attack Matrix", () => {
    beforeEach(() => {
        vi.clearAllMocks()
