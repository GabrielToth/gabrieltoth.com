/**
 * Security Tests for POST /api/oauth/disconnect/facebook — Attack Matrix
 *
...
import { POST } from "@/app/api/oauth/disconnect/facebook/route"
...
describe("POST /api/oauth/disconnect/facebook — Attack Matrix", () => {
    beforeEach(() => {
        vi.clearAllMocks()
    })
    ...
    describe("Row 2 — HTTP method confusion", () => {
        it("should not expose GET handler for disconnect", async () => {
            const route =
                await import("@/app/api/oauth/disconnect/facebook/route")
    ...
    describe("Row 16 — Business logic", () => {
        it("should return 404 when Facebook is not linked", async () => {
