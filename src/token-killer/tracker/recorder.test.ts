...
describe("TokenRecorder", () => {
    ...
    describe("recordToken", () => {
        ...
        it("should calculate BRL cost correctly", async () => {
            ...
            expect(running!.currentCostBRL).toBeCloseTo(
                running!.currentCostUSD * 5.0,
                6
            )
        })
        ...
        it("should reject negative token counts", async () => {
            ...
            await expect(recorder.recordToken(request)).rejects.toThrow(
    ...
    describe("Exchange Rate", () => {
        ...
        it("should reject negative exchange rate", () => {
            expect(() => recorder.setExchangeRate(-1)).toThrow(
                "Exchange rate must be positive"
            )
        })

        it("should reject zero exchange rate", () => {
            expect(() => recorder.setExchangeRate(0)).toThrow(
                "Exchange rate must be positive"
            )
        })
