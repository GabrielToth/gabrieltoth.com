...
describe("StorageRecoveryManager", () => {
    ...
    describe("integrity checks", () => {
        ...
        it("should check database file existence", async () => {
            ...
            const fileCheck = result.checks.find(
                c => c.name === "Database file exists and readable"
            )
        ...
        it("should check database connection health", async () => {
            ...
            const healthCheck = result.checks.find(
                c => c.name === "Database connection health"
            )
        ...
        it("should check foreign key constraints", async () => {
            ...
            const fkCheck = result.checks.find(
                c => c.name === "Foreign key constraints"
            )
        ...
        it("should check data consistency", async () => {
            ...
            const dataCheck = result.checks.find(
                c => c.name === "Data consistency"
            )
        ...
        it("should check constraint violations", async () => {
            ...
            const constraintCheck = result.checks.find(
                c => c.name === "Constraint violations"
            )
        ...
        it("should check archive integrity", async () => {
            ...
            const archiveCheck = result.checks.find(
                c => c.name === "Archive integrity"
            )
    ...
    describe("consistency validation", () => {
        ...
        it("should check token records count", async () => {
            ...
            const recordCheck = result.checks.find(
                c => c.name === "Token records count"
            )
        ...
        it("should check enabled budget configs", async () => {
            ...
            const budgetCheck = result.checks.find(
                c => c.name === "Enabled budget configs"
            )
        ...
        it("should check enabled strategies", async () => {
            ...
            const strategyCheck = result.checks.find(
                c => c.name === "Enabled strategies"
            )
