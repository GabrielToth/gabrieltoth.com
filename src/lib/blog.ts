...
export const BLOG_POSTS: BlogPost[] = [
    {
        ...
        description: {
            ...
            "pt-BR":
                "Guia completo para alcançar pontuação 100 no Lighthouse com Next.js 16, ISR e React Server Components.",
        ...
        content: {
            ...
            "pt-BR":
                "A otimização de desempenho em aplicações web modernas exige uma abordagem holística que vai do rendering no servidor até a otimização de imagens...",
