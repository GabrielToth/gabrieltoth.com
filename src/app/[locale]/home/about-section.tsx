            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="space-y-6">
                        <div>
                            <p className="text-foreground dark:text-foreground leading-relaxed mb-6">
                                {t("intro")}
                            </p>
                            <p className="text-foreground dark:text-foreground leading-relaxed mb-6">
                                {t("experience")}
                    ...
                    {/* Skills */}
                    <div className="bg-card dark:bg-background rounded-2xl p-8 shadow-lg">
                        <h3 className="text-2xl font-bold text-foreground dark:text-foreground mb-8">
                            {t("skills.title")}
                        </h3>
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {(
                                        ...
                                        <span
                                            key={skill}
                                            className="px-3 py-1 bg-primary/10 dark:bg-primary/10 text-primary dark:text-primary rounded-full text-sm font-medium"
                                        >
                                            {skill}
                                        </span>
                                    ))}
