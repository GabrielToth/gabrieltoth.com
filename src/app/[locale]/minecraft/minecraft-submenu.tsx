        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            {categories.map(category => (
                <Link
                    ...
                    className="group bg-card border border-border/60 rounded-xl p-6 hover:border-[#10b981] transition-all duration-200 hover:shadow-lg hover:shadow-[#10b981]/20"
                >
                    <h3 className="text-lg font-bold mb-2 text-foreground group-hover:text-[#10b981] transition-colors">
                        {category.label}
                    </h3>
