                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-16">
                            ...
                            <Link
                                ...
                                className="group bg-[#171717] border border-neutral-700 rounded-lg p-8 hover:border-[#10b981] transition-all duration-200 hover:shadow-lg hover:shadow-[#10b981]/20"
                            >
                        ...
                        <div className="bg-[#242424] border border-neutral-700 rounded-lg p-8 max-w-4xl mx-auto">
                            ...
                            <div className="grid md:grid-cols-3 gap-6 mt-8">
                                ...
                                <Link
                                    ...
                                    className="bg-[#171717] border border-neutral-700 rounded-lg p-6 hover:border-[#10b981] transition-all duration-200 hover:shadow-lg hover:shadow-[#10b981]/20"
                                >
