    ...
    return (
        <>
            ...
            <Link
                ...
                className="w-full px-4 py-3 bg-primary hover:bg-primary dark:bg-primary dark:hover:bg-primary text-primary-foreground rounded-full font-medium transition-colors text-center block mb-6"
            >
