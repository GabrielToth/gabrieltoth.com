...
export async function GET(request: NextRequest): Promise<NextResponse> {
    try {
        ...
        const { data, error } = await supabase
            .from("repost_configs")
            .select("*, source_channel:channels!repost_configs_source_channel_id_fkey(*), target_group:channel_groups!repost_configs_target_group_id_fkey(*)")
...
export async function PATCH(request: NextRequest): Promise<NextResponse> {
    try {
        ...
        if (body.check_interval_minutes) update.check_interval_minutes = body.check_interval_minutes
        if (body.target_group_id !== undefined) update.target_group_id = body.target_group_id
