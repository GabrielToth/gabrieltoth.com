...
const getTranslations = (locale: Locale) => {
    ...
    return {
        ...
        passion: isPortuguese
            ? "Além da análise e ciência de dados, gerencio canais como o canal WaveIGL com mais de 2 milhões de visualizações mensais criando conteúdo para diversas redes sociais. Desenvolvi o ViraTrend, um produto especializado em consultoria de crescimento digital para criadores de conteúdo. Tenho paixão por transformar dados em insights acionáveis e usar machine learning para otimizar campanhas digitais e experiências do usuário."
            : "Beyond data analysis and science, I manage channels like the WaveIGL channel with over 2 million monthly views and create content on social media. I developed ViraTrend, a specialized product for digital growth consulting for content creators. I'm passionate about transforming data into actionable insights and using machine learning to optimize digital campaigns and user experiences.",
        skills: {
