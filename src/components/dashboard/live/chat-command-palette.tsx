...
export function ChatCommandPalette({
    ...
    return (
        <div className="absolute bottom-full mb-1 left-0 right-0 max-h-48 overflow-y-auto rounded-lg border border-neutral-700 bg-neutral-900 p-1 shadow-lg z-20 text-xs">
