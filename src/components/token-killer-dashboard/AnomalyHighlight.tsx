      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-amber-800 dark:text-amber-200 mt-1">
            {anomalies.anomalies.length} unusual token consumption pattern
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right ml-4">
                    <p className="text-sm font-semibold text-amber-600 dark:text-amber-400">
                      {anomaly.totalTokens.toLocaleString()} tokens
                    </p>
          ...
          <div className="mt-4 p-3 bg-white dark:bg-slate-800 rounded border border-amber-100 dark:border-amber-800">
            <p className="text-sm text-slate-700 dark:text-slate-300">
              <span className="font-semibold">Recommendation:</span> Review these
              anomalies to identify potential optimization opportunities or
