...
export const ErrorStateStory: StoryObj<typeof ErrorState> = {
    render: args => <ErrorState error={args.error} onRetry={args.onRetry} />,
    args: {
        ...
        <div className="p-8 max-w-4xl mx-auto">
            ...
            <section className="mb-8">
                ...
                <p className="text-gray-700 mb-4">
                    The Token Killer Dashboard provides comprehensive
                    visualization of token consumption across your applications
                    with interactive charts, real-time updates, and anomaly
                    detection.
                </p>
            </section>
            ...
            <section className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700">
                    ...
                    <li>
                        Interactive charts with uPlot for high-performance
                        rendering
                    </li>
                ...
                <div className="space-y-4">
                    <div className="border-l-4 border-blue-500 pl-4">
                        ...
                        <p className="text-gray-700">
                            Main dashboard component that orchestrates all
                            sub-components
                        </p>
                    </div>
                    <div className="border-l-4 border-blue-500 pl-4">
                        ...
                        <p className="text-gray-700">
                            Allows users to select different time windows for
                            visualization
                        </p>
                    </div>
                    <div className="border-l-4 border-blue-500 pl-4">
                    ...
                    <div className="border-l-4 border-blue-500 pl-4">
                        ...
                        <p className="text-gray-700">
                            Shows token distribution by various dimensions
                        </p>
                    </div>
                    <div className="border-l-4 border-blue-500 pl-4">
                        <h3 className="font-semibold">AnomalyHighlight</h3>
                        <p className="text-gray-700">
                            Displays detected anomalies with context and
                            recommendations
                        </p>
                    </div>
                    <div className="border-l-4 border-blue-500 pl-4">
                        ...
                        <p className="text-gray-700">
                            Shows skeleton loading state while data is being
                            fetched
                        </p>
                    </div>
                    <div className="border-l-4 border-blue-500 pl-4">
                        ...
                        <p className="text-gray-700">
                            Displays error messages with troubleshooting steps
                        </p>
                    </div>
                    <div className="border-l-4 border-blue-500 pl-4">
                        <h3 className="font-semibold">DashboardHeader</h3>
                        <p className="text-gray-700">
                            Header with title and controls for refresh and
                            auto-refresh
                        </p>
                    </div>
                </div>
            ...
            <section>
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700">
                    ...
                    <li>
                        ✅ Requirement 6.3: Interactive charts with canvas
                        rendering
                    </li>
